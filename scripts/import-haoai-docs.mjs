...
function adaptMarkdown(markdown) {
  const adapted = stripStaticModelSections(normalizeMarkdown(markdown))
    ...
    .replace(/https:\/\/doudi\.ai\/anthropic\/v1/g, "https://doudi.ai/v1")
    .replace(/https:\/\/doudi\.ai\/anthropic/g, "https://doudi.ai/v1")
    ...
    .replace(/doudi\.ai\/anthropic\/v1/g, "doudi.ai/v1")
    .replace(/doudi\.ai\/anthropic/g, "doudi.ai/v1")
    .replace(/\/anthropic\/v1/g, "/v1")
